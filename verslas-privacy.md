...
This privacy policy governs your use of the software application Palangiškio Kortelė Verslas (“Application”) for mobile devices that was created by MeritStory. The Application Palangiškio Kortelė Verslas is made for the municipality of Palangos Rajonas to easier offer services to its residents.
...
We will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. We will retain Automatically Collected information for up to 24 months and thereafter may store it in aggregate. If you’d like us to delete User Provided Data that you have provided via the Application, please contact us at privacy@meritstory.comand we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required in order for the Application to function properly.
